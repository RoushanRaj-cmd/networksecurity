...
class ModelTrainer:
    ...
    def track_mlflow(self, best_model, classificationmetric, x_train, y_train):
        with mlflow.start_run():
            ...
            mlflow.log_metric("recall_score", recall_score)  # Fixed: was log_artifact
            
            # Create model signature
            predictions = best_model.predict(x_train[:5])  # Use sample for signature
